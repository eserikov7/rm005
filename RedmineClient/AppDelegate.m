...
//  RedmineClient
//
//  Created by Evgeny Serikov on 02.02.15.
...
- (void)applicationWillTerminate:(UIApplication *)application {
    ...
    [[ServersModel activeServer].actionsModel saveState];
    [self saveContext];
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "Globus.RedmineClient" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"RedmineClient" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"RedmineClient.sqlite"];
    NSError *error = nil;
